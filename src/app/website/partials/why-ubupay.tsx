...
const WhyUbupay = () => {
    return (
        <section className="bg-primary w-full  mt-[0px] xl:mt-[140px] lg:mt-[140px] md:mt-[140px] py-[0px] xl:py-[100px] lg:py-[100px] md:py-[100px] rounded-[0px]">
            <div className="flex flex-col md:flex-row px-6 mx-[0px] xl:mx-[70px] md:mx-[30px] lg:mx-[30px] py-10 ">
                <div className="w-full xl:w-[45%] md:w-[40%]  lg:w-[40%] flex flex-col justify-center items-start  mb-6 md:mb-0">
                    <h1 className="text-[#ffffff] xl:pr-[160px] lg:pr-[100px] md:pt-[50px] lg:pt-[50px] xl:pt-[50px] pt-[30px] leading-tight lg:leading-[53px] xl:leading-[50px] xl:pb-[5px] md:pb-[10px] lg:pb-0 pb-[10px] pt-0 lg:pt-0 xl:pt-2 md:pt-[100px] lg:text-[40px] xl:text-[40px] font-bold text-2xl">
                        Seamless secure
                    ...
                    <button className="px-6 xl:mt-[50px] lg:mt-[50px] md:mt-[50px] mt-[30px] py-2 btn-readmore  transition">
                        Learn More
                    </button>
